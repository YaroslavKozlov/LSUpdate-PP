...
$AppServerVer = "4.9.10.3012"
$ShiftVer_old = "4.9.10.3012"
$ShiftVer_new = "4.9.10.3012."
# описание функций
function freshUpdateServer {
    param (
        [PARAMETER(Mandatory=$True,Position=0)][String]$DirSrc,
        [PARAMETER(Mandatory=$True,Position=1)][String]$DirDST
    )
    #
